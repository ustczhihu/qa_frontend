...
<template>
  <div class="content">
      ...
      <div class="post-content">
        <ul class="cat">
          <li class="cat-item active">
            <i class="iconfont icon-edit"></i>question
          </li>
        </ul>
        <div class="post-sub-container">
          <div class="post-sub-header">
            ...
            ></textarea>
            <span class="textarea-num">{{ titlelen }}/80</span>
          </div>
          <!---此处放置富文本--->
          <div class="post-text-con">
            ...
            ></textarea
            ><span class="textarea-num">{{ contentlen }}/300</span>
          </div>
        </div>
    ...
    <div class="right">
      <div class="post-rank">
        <h5 class="p-r-title">
          <i class="p-r-icon"></i>让你的第一个问题获得更多解答
        </h5>
        <ul class="p-r-content">
          <li class="p-r-item">1.保持文字简练，表述清晰问题的关键点</li>
          <li class="p-r-item">2.添加合适的话题，让问题更好地流通</li>
          <li class="p-r-item">3.确保问题没有被提问过</li>
        </ul>
      </div>
    </div>
  </div>
  ...
  watch: {
    title: function () {
      ...
      if (this.titlelen > 80) {
        ...
        this.$message.error('title字数超过最大容量')
      }
    },
    content: function () {
      this.contentlen = this.content.length
      if (this.contentlen > 300) {
        this.content = this.content.slice(0, 300)
        this.$message.error('content字数超过最大容量')
      }
    },
  },
  mounted: function () {
